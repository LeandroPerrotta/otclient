# Smart OpenSSL finder that supports both vcpkg and system libraries
...
if(DEFINED CMAKE_TOOLCHAIN_FILE AND CMAKE_TOOLCHAIN_FILE MATCHES "vcpkg")
    message(STATUS "OpenSSL: vcpkg detected, skipping custom finder")
    # Exit early and let vcpkg handle it via the standard CMake integration
    return()
endif()

# Traditional system library search (Linux/manual installs)
message(STATUS "OpenSSL: Using system library search")
